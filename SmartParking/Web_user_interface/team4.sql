...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 03, 2023 at 04:24 PM
...
(20, 'testet', '$2y$10$trvddvO8qOXelUmCsXCbEuyLLNFLcrSQpt2PkrSP1Q7UmA5ve8/QS', '2023-06-02 12:05:08', 'Hakim', '16db6881', 'Male', 'hakim@gmail.com', 'xenia', 'user', 0);
...
INSERT INTO `temporary_register` (`id`, `name`, `status`, `balance`) VALUES
('90a44c26', 'SystemTest', 'inside', 49403),
('c2a4ba1b', 'Nabil Bachroin', 'outside', 1907779),
('b9a91614', 'no-name', 'outside', 0),
('82a1bd1b', 'no-name', 'outside', 0),
('b2878e1a', 'no-name', 'outside', 0),
('16db6881', 'no-name', 'outside', 0);
